...
@typecast.register
def complex_from_str(deepcast: Typecast, cls: type[complex], val: str) -> complex:
...
def complex_from_Iterable(
    deepcast: Typecast, cls: type[complex], val: Iterable
) -> complex:
...
@typecast.register
def complex_from_Number(deepcast: Typecast, cls: type[complex], val: Number) -> complex:
